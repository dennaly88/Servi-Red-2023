          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box box-primary">
               ...
               <center> <a href="#registro" class='btn btn-primary btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-plus'></span>Nuevo</a>
      </div> 
                ...
                <?php
                  ...
                  <td><a href='#foto_".$row['id']."'  data-toggle='modal'><span >$imagen</a></td>
									...
									<td width='300' height='20'>
										<a href='#actualizar_".$row['id']."' class='btn btn-info btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'title='Editar'></span></a>
										<a href='#eliminar_".$row['id']."' class='btn btn-danger btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-trash'title='Eliminar'></span> </a>
									</td>
								</tr>";
