    ...
    <div class="modal-dialog">
        ...
        <div class="modal-header">
            ...
            <div class="modal-body">	
                ...
                <?php   $imagen = '<img height="100" width="100" src="data:image/jpeg;base64,'.base64_encode($row["imagen"]).'"/>';?>
            ...
            <div class="modal-footer">
                ...
                <a href="sql/eliminar-material.php?id=<?php echo $row['id']; ?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-trash"></span>Aceptar</a>
            </div>
            </div>
        </div>
    </div>
