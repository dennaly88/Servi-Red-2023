...
<div class="modal fade" id="ubicacion_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
		...
		<div class="modal-header">
                ...
                <center><h4 class="modal-title" id="myModalLabel"><button class="btn bg-navy btn-sm" type="button"> <span class='fa fa-camera'></span>&nbsp;Ubicacion del Router</button></h4></center>
				<br><div class="box box-primary">
			</div>
            <div class="modal-body">
			<div class="container-fluid">
			<form method="POST" action="sql/ubicacion-router.php" enctype="multipart/form-data">
							...
							<div class="row form-group">
								...
								<?php  $unicacion = '<img height="80" width="80" src="data:image/jpeg;base64,'.base64_encode($row["ubicacion_geografica"]).'"/>';?>
								<?php echo  $ubicacion; ?>	
								</div>
							</div>
                            <div class="row form-group">
