...
<html>
  ...
  <body class="skin-blue">   
       ...
       <?php include ('../paginas/principal-menu.php');  ?>
              ...
              <?php include ('principal-router.php');  ?> 
             
              <script>
	     window.history.pushState("object", "", "http://localhost/administrador/routers/principal.php");
</script>
...
switch ($usu) { 
    case 1:    
      require ("mensajes/router-editado.php"); 
        break;
          case 2:
            require ("mensajes/router-agregado.php"); 
              break;
                  case 3: 
                    require ("mensajes/router-eliminado.php"); 
                          break;   
                          
                          case 4: 
                            require ("mensajes/router-duplicado.php"); 
                                  break; 
}
