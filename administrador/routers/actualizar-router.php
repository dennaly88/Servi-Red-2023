...
<div class="modal fade" id="edit_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
		...
		<div class="modal-header">
                ...
                <center><button class="btn bg-navy btn-sm" type="button"> <span class='glyphicon glyphicon-edit'>&nbsp;</span>Editar el Router</button></center>
				<br><div class="box box-primary">
			</div>
            <div class="modal-body"> 
			<div class="container-fluid">
			<form method="POST" action="sql/editar-router.php" enctype="multipart/form-data">
							...
							<div class="row form-group">
								...
								<div class="col-sm-10">
									<input type="password" class="form-control" name="clave_administrador" value="<?php echo $row['clave_administrador']; ?>" required>
								</div>
							</div>
							<div class="row form-group">
								<div class="col-sm-2">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="ssid" value="<?php echo $row['ssid']; ?>">
								</div>
							</div>
							<div class="row form-group">
								<div class="col-sm-2">
								...
								<div class="col-sm-10">
									<input type="password" class="form-control" name="clave_paso" value="<?php echo $row['clave_paso']; ?>" >
								</div>
							</div>
							<?php
					...
					<div class="col-sm-10">
					     <select class="form-control form-control-sm" placeholder="Seleccione el Perfil" name="ubicacion" required>
							...
							<div class="row form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="remoto" value="<?php echo $row['ip']; ?>" required>
								</div>
							</div>
						...
						<div class="modal-footer">
							...
							<button type="submit" name="editar" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-check"></span>Actualizar Router</a>
			</form>
            </div>
        </div>
    </div>
