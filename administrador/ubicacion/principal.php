...
<html>
  ...
  <body class="skin-blue">   
       ...
       <?php include ('../paginas/principal-menu.php');  ?>
              ...
              <?php include ('principal-ubicacion.php');  ?> 
              <?php
                   $usu=$_GET["usu"];
                    switch ($usu) { 
                      case 1:    
                      require ("mensajes/ubicacion-editado.php"); 
                      break;
                      case 2:
                      require ("mensajes/ubicacion-agregado.php"); 
                      break;
                      case 3: 
                      require ("mensajes/ubicacion-eliminado.php"); 
                      break;       
                      case 4: 
                      require ("mensajes/servidor-duplicado.php"); 
                      break; 
                      case 5: 
                        require ("mensajes/conexion-ubicacion.php"); 
                        break; 
} 
?>       
    </div>
