    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header"> 
                ...
                <center><h4 class="modal-title" id="myModalLabel"><button class="btn bg-navy btn-sm" type="button"><span class='fa fa-upload'>&nbsp;</span>Registrar Servicio</button></h4></center>
<br>
			...
			<div class="container-fluid">
                <form action="sql/insertar-servicio.php" method="post" enctype="multipart/form-data">
				...
				<div class="row form-group"> 
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="nombre" placeholder="Ingresar Nombre del Servicio" required>
					</div> 
				</div>
            </div> 
			</div>
