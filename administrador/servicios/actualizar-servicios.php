...
<div class="modal fade" id="edit_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
		...
		<div class="modal-header">
                ...
                <center><button class="btn bg-navy btn-sm" type="button"> <span class='fa fa-upload'>&nbsp;</span>Editar Servicios</button></center>
				<br><div class="box box-primary">
			</div>
            <div class="modal-body">
			<div class="container-fluid">
			<form method="POST" action="sql/editar-servicios.php?usu=<?php echo $row['imagen']; ?>" enctype="multipart/form-data">
