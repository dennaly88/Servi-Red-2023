...
<html>
  ...
  <body class="skin-blue">   
       ...
       <div class="content-wrapper"> 
              ...
              <?php include ('principal-ad-materiales.php');  ?> 


<script>
	     window.history.pushState("object", "", "http://localhost/administrador/administrador-materiales/principal.php");
</script>
              ...
              switch ($usu) { 
                  ...
                  case 5:require ("mensajes/ad-material-estado.php"); 
                    break; 
                    case 6:require ("mensajes/ad-material-insuficiente.php"); 
                    break;
} 
?>      
    </div>
