...
<div class="modal fade" id="delete_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-header">
                ...
                <center><button class="btn bg-navy btn-sm" type="button"> <span class='glyphicon glyphicon-trash'></span>&nbsp;Eliminar Sistemas</button></center>
            ...
            <div class="modal-footer">
                ...
                <a href="sql/eliminar-sistemas.php?id=<?php echo $row['id']; ?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-trash"></span>Aceptar</a>
            </div>
            </div>
        </div>
    </div>
