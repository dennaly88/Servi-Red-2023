        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center><h4 class="modal-title" id="myModalLabel">
                  <button class="btn btn-primary" type="button"> <span class='fa fa-lock'></span>&nbsp;Contraseña</button>
			...
			<form method="POST" action="sql/contraseña.php" enctype="multipart/form-data">
                            ...
                            <div class="row form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="#" value="<?php echo $row['clave']; ?>" readonly>
								</div>
							</div>
                            <?php
									$clave= $row['clave'];
									...
									$de = openssl_decrypt(base64_decode($clave), $method, $sSalt, OPENSSL_RAW_DATA, $iv);
                              ?>
                                ...
                                <div class="row form-group">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" name="edit_contraseña" value="<?php echo $de; ?>" readonly>
											</div>
			...
			<div class="modal-footer">
							...
							<button type="submit" name="editar" class="btn btn-success"><span class="glyphicon glyphicon-check"></span>Cambiar Contraseña</a>
			</form>
            </div>
			</div>
        </div>
