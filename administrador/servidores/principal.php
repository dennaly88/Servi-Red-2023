...
<html>
  ...
  <body class="skin-blue">   
       ...
       <div class="content-wrapper"> 
              ...
              <?php include ('principal-servidores.php');  ?> 
             
<script>
	     window.history.pushState("object", "", "http://localhost/administrador/servidores/principal.php");
</script>
...
switch ($usu) { 
    case 1:    
      require ("mensajes/servidor-editado.php"); 
        break;
          case 2:
            require ("mensajes/servidor-agregado.php"); 
              break;
                  case 3: 
                    require ("mensajes/servidor-eliminado.php"); 
                          break;   
                          
                          case 4: 
                            require ("mensajes/servidor-duplicado.php"); 
                                  break; 
} 
