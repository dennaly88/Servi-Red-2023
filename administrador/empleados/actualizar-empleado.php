		...
		<div class="modal-header">
			...
			<form method="POST" action="sql/editar-empleado.php" enctype="multipart/form-data">
							...
							<div class="row form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="edit_cedula" value="<?php echo $row['cedula']; ?>" required>
								</div>
							</div>
							<div class="row form-group">
								<div class="col-sm-2">
								...
								<div class="col-sm-10">
									<input type="email" class="form-control" name="edit_corre" value="<?php echo $row['corre'];?> " required >
								</div>
							</div>
							<div class="row form-group">
								<div class="col-sm-2">
