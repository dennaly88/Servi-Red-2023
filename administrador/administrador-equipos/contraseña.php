        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center><h4 class="modal-title" id="myModalLabel">
                  <button class="btn btn-primary" type="button"> <span class='fa fa-lock'></span>&nbsp;Cambiar la Contraseña del Usuario</button>
			...
			<form method="POST" action="sql/contraseña.php?usu=<?php echo $row['imagen']; ?>" enctype="multipart/form-data">
