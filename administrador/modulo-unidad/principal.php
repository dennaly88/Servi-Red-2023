...
<html>
  ...
  <body class="skin-blue">   
       ...
       <div class="content-wrapper"> 
              ...
              <?php include ('principal-unidad.php');  ?> 
             
<script>
	     window.history.pushState("object", "", "http://localhost/administrador/modulo-unidad/principal.php");
</script>
...
switch ($usu) { 
    case 1:    
      require ("mensajes/unidad-editado.php"); 
        break;
          case 2:
            require ("mensajes/unidad-agregado.php"); 
              break;
                  case 3: 
                    require ("mensajes/unidad-eliminado.php"); 
                          break;   
                          
                          case 4: 
                            require ("mensajes/unidad-duplicado.php"); 
                                  break; 
}
