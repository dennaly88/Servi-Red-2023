...
<html>
  ...
  <body class="skin-blue">   
       ...
       <div class="content-wrapper"> 
              ...
              <?php include ('principal-wifi.php');  ?> 
             
  <script>
	     window.history.pushState("object", "", "http://localhost/administrador/wifi/principal.php");
</script>
...
switch ($usu) { 
    case 1:    
      require ("mensajes/wifi-editado.php"); 
        break;
          case 2:
            require ("mensajes/wifi-agregado.php"); 
              break;
                  case 3: 
                    require ("mensajes/wifi-eliminado.php"); 
                          break;   
                          
                          case 4: 
                            require ("mensajes/wifi-duplicado.php"); 
                                  break; 
}
