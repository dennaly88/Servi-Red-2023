...
<div class="modal fade" id="registro_usuario" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
		...
		<div class="modal-header">
                ...
                <center><h4 class="modal-title" id="myModalLabel"><button class="btn bg-navy btn-sm" type="button"><span class='fa fa-wifi'>&nbsp;</span>Registrar Equipo Inalambrico</button></h4></center>
				<br><div class="box box-primary">
			</div>
            <div class="modal-body"> 
			<div class="container-fluid">
                <form action="sql/insertar-wifi.php" method="post" enctype="multipart/form-data">
				<script>
              function archivo(evt) {
                  ...
                  for (var i = 0, f; f = files[i]; i++) {
                    ...
                    reader.onload = (function(theFile) {
                        return function(e) {
                         document.getElementById("list").innerHTML = ['<img class="thumb"  width="100" height="100" src="', e.target.result,'" title="', escape(theFile.name), '"/>'].join('');
                        };
                    })(f); 
      ...
      <div class="row form-group">
		...
		<div class="row form-group">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" name="ssid" required placeholder="Ingrese SSID" required>
			</div>
		</div>
        ...
        <div class="row form-group">
			...
			<div class="col-sm-10">
				<select class="form-control form-control-sm" placeholder="Seleccione el Perfil" name="id-ubicacion" placeholder="Ingrese la Ubicación" required>
