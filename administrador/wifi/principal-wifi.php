...
<html>
            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">INTERFAZ DE EQUIPOS INALAMBRICOS</h3>
                </div>
                <div class="box-body"> 
               <center> <a href="#registro_usuario" class='btn btn-primary btn-sm' data-toggle='modal'><span class='fa fa-wifi '></span> &nbsp;Nuevo Equipo Inalambrico</a>
      </div> 
                ...
                <?php
                     $sql="SELECT * from wifi order by id desc";
                  ...
                  <td><a href='#ubicacion_".$row['id']."'  data-toggle='modal'><span >$ubicacion</a></td>
                    ...
                    <a  href='../reportes/ver-wifi.php?id=$row[id]'   title='Ver PDF' class='btn bg-maroon  btn-sm' data-toggle='modal' target='_blank'><span class='fa fa-file-pdf-o' ></span></a>

                    <a  href='../reportes/descargar-wifi.php?id=$row[id]'   title='Descargar PDF' class='btn bg-purple btn-flat  btn-sm' data-toggle='modal' target='_blank'><span class='fa fa-download' ></span></a>
                     </td>
                ...
                include('consola.php');
                include('perfil.php');
                include('registrar-wifi.php');
								include('actualizar-wifi.php');
								include('eliminar-wifi.php');
  ...
  <center> <a  href='../reportes/ver-total-wifi.php'   title='Ver Total de wifi PDF' class='btn bg-navy btn-sm' data-toggle='modal' target='_blank'><span class='fa fa-file-pdf-o' ></span></a>

  <a  href='../reportes/descargar-total-wifi.php'   title='Descargar Total de Wifi PDF' class='btn bg-primary btn-flat  btn-sm' data-toggle='modal' target='_blank'><span class='fa fa-download' ></span></a>
  
  <br><br>
  <?php include('contador-wifi.php');?>
