            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">INTERFAZ DE SWITCH</h3>
                </div>
                <div class="box-body"> 
               <center> <a href="#registro_usuario" class='btn btn-primary btn-sm' data-toggle='modal'><span class='fa fa-tasks'></span> &nbsp;Nuevo</a>
      </div> 
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    ?>
                <?php
                     $sql="SELECT * from switch order by id desc";
                ...
                <td>".$row['id']."</td>
                  ...
                  <td width='300' height='20'>
                    ...
                    <a  href='../reportes/ver-switch.php?id=$row[id]'   title='Ver PDF' class='btn bg-maroon  btn-sm' data-toggle='modal' target='_blank'><span class='fa fa-file-pdf-o' ></span></a>

                    <a  href='../reportes/descargar-switch.php?id=$row[id]'   title='Descargar PDF' class='btn bg-purple btn-flat  btn-sm' data-toggle='modal' target='_blank'><span class='fa fa-download' ></span></a>
                ...
                include('consola.php');
                include('perfil.php');
                include('registrar-switch.php');
								include('actualizar-switch.php');
								include('eliminar-switch.php');
                include('contraseña.php');
                  ...
                  <center> <a  href='../reportes/ver-total-switch.php'   title='Ver Total de Switch PDF' class='btn bg-navy btn-sm' data-toggle='modal' target='_blank'><span class='fa fa-file-pdf-o' ></span></a>

                  <a  href='../reportes/descargar-total-switch.php'   title='Descargar Total de Switch PDF' class='btn bg-primary btn-flat  btn-sm' data-toggle='modal' target='_blank'><span class='fa fa-download' ></span></a>

  <br><br>
  <?php include('contador-switch.php');?>
