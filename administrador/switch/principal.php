  ...
  <body class="skin-blue">   
       ...
       <div class="content-wrapper"> 
             <?php include ('../paginas/principal-menu.php');  ?>
              ...
              <?php include ('principal-switch.php');  ?> 
            
              <script>
	     window.history.pushState("object", "", "http://localhost/administrador/switch/principal.php");
</script>
...
switch ($usu) { 
    case 1:    
      require ("mensajes/switch-editado.php"); 
        break;
          case 2:
            require ("mensajes/switch-agregado.php"); 
              break;
                  case 3: 
                    require ("mensajes/switch-eliminado.php"); 
                          break;   
                          
                          case 4: 
                            require ("mensajes/switch-duplicado.php"); 
                                  break; 
}
