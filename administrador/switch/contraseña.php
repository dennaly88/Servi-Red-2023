    ...
    <div class="modal-dialog">
		...
		<div class="modal-header">
                ...
                <center><h4 class="modal-title" id="myModalLabel">
                  <button class="btn bg-navy btn-sm" type="button"> <span class='fa fa-lock'></span>&nbsp;Contraseña del Switch</button>
                            ...
                            <?php
                              ...
                              ?>
                                ...
                                <div class="row form-group">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" name="edit_contraseña" value="<?php echo $row['clave']; ?>" readonly>
											</div>
