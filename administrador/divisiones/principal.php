...
<html>
  ...
  <body class="skin-blue">   
       ...
       <div class="content-wrapper"> 
              ...
              <?php include ('../paginas/principal-division.php');  ?> 
              
             
             
             <script>
	     window.history.pushState("object", "", "http://localhost/administrador/divisiones/principal.php");
</script>
            
            <?php
              $usu=$_GET["usu"];
              switch ($usu) { 
                  case 1:require ("mensajes/division-editado.php"); 
                  break;
                  case 2:require ("mensajes/division-agregado.php"); 
                    break;
                  case 3:require ("mensajes/division-eliminado.php"); 
                    break;   
                  case 4:require ("mensajes/division-duplicado.php"); 
                    break; 
                     } 
?>  
