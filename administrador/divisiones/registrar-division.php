    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header"> 
                ...
                <center><h4 class="modal-title" id="myModalLabel"><button class="btn bg-navy btn-sm" type="button"><span class='fa fa-list'>&nbsp;</span>Registrar División</button></h4></center>
<br>
			...
			<div class="container-fluid">
                <form action="sql/insertar-division.php" method="post" enctype="multipart/form-data">
				...
				<div class="row form-group"> 
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="nombres" placeholder="Ingresar Nombre de la División" required>
					</div> 
				</div> 
                ...
                <div class="row form-group"> 
					...
					<div class="col-sm-10">
                           <select type="text" class="form-control" id="gerencias" name= "gerencias" placeholder="Ingresar Nombre del Servicio"required> 
